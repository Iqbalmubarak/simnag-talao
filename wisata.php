        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Tageh Wisata</h1>
              <ol class="breadcrumb">
        ...
        while ($row = $result2 ->fetch_assoc())
        {
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> 
              <div>
                <img class="img-responsive" src="user/wisata/wisata_img/<?php echo $row['w_image']; ?>">
              </div> 
            </div>
            <div class="blog_feature_cantant">
              <p class="blog_head"><?php echo $row['w_name']; ?></p>
              <div class="post_info">
                <ul>
                  <li><i class="fa fa-map" aria-hidden="true"></i> <?php echo $row['w_location']; ?></li>
                </ul>
              </div>
