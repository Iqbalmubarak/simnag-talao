        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Visi Misi Nagari</h1>
              <ol class="breadcrumb">
...
<a style="font-weight:bold;" >Terwujudnya Nagari Talao Sungai Kunyit sebagai Nagari yang Maju, Mandiri, Berilmu, Islami, dan Berperstasi untuk Kesejahteraan Masyarakat.</a><br><br>
               </p>
              </div>
            </div>
            <div class="col-md-12">
              <div class="full">
                <h2>MISI</h2>
                <p><a style="font-weight:bold;" >1.</a> Mewujudkan Pemerintah Nagari yang Aman, Bersih, dan Bermartabat melalui segala aspek bidang yang mampu mendukung nagari dalam proses pencapaian tujuan.<br><br>
                  <a style="font-weight:bold;" >2.</a> Meningkatkan Pertumbuhan dan Pemerataan Ekonomi yang Memberi Kesejahteraan terhadap Taraf Hidup Masyarakat Nagari Berbasis Ekonomi Kerakyatan lewat berbagai Sektor Seperti Perkebunan, Pertanian, Peternakan, Perikanan, Perdagangan, serta Koperasi.<br><br>
                  <a style="font-weight:bold;" >3.</a> Meningkatkan Kondisi Sosial Budaya Masyarakat yang Berlandaskan pada "Adat Basandi Syarak, Syarak Basandi Kitabullah" dan Melaksanakan Peningkatan Kualitas Pendidikan Sebagai Dasar Pembangunan Kemajuan Nagari Baik dari Pendidikan Formal dan Non Formal seperti pendidikan. Pendidikan Anak Usia Dini sampai Sekolah Menengah Atas, Pendidikan Agama dan adat dalam rangka mewujudkan kekokohan Iman dan Taqwa serta kualitas nagari.<br><br>
                  <a style="font-weight:bold;" >4.</a> Meningkatkan Pembangunan Sarana dan Prasarana Kesehatan Guna Mendorong Terciptanya Sumber Daya Manusia Berkualitas.<br><br>
                  
                  <a style="font-weight:bold;" >5.</a> Memberi Rasa Nyaman bagi Semua Lapisan Masyarakat dengan Kesamaan Hukum baik Hukum Negara Maupun Hukum Adat<br><br>
                  <a style="font-weight:bold;" >6.</a> Menciptakan Kinerja Aparatur Nagari yang Profesional, Produktif, dan Bersih.<br><br>
                  <a style="font-weight:bold;" >7.</a> Menciptakan Keamanan dan Kenyamanan bagi Perusahaan dan Dunia Usaha sebagai Salah Satu Mitra Nagari untuk Membangun Nagari Secara Bersama dan Berkelanjutan.</p>
                </div>
              </div>
      ...
      <ul class="navbar-nav nav-justified w-100">
        <li class="nav-item">
          <a style="color: white;" href="it_home.html" class="nav-link text-center">
            <i style="font-size:large;" class="fa fa-home my-float"></i>
            <span class="small d-block">Beranda</span>
          </a>
        </li>
        <li class="nav-item">
          <a style="color: white;" href="berita1.html" class="nav-link text-center">
        ...
        <li class="nav-item dropup">
          <a style="color: white;" href="kontak.html" class="nav-link text-center" >
