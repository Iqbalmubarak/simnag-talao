          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li class="active"> <a href="kontak.php">KONTAK</a>
        ...
        <div class="row">
          <div class="full">
            ...
            <div class="contact_information">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 adress_cont">
                <div class="information_bottom text_align_center">
                  <div class="icon_bottom"><i class="fas fa-exclamation-circle"></i></div>
                  <div class="info_cont">
                    <h4>BABINKATIBNAS</h4>
                    <p>24/7 Online Support</p>
                     <div class="center"><a  style="background-color: <?php echo $n_color ?>;" class="btn " href="tel:<?php echo $key['n_kontak2']; ?>">HUBUNGI</a></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 adress_cont">
                <div class="information_bottom text_align_center">
                  <div class="icon_bottom"> <i class="fas fa-ambulance"></i> </div>
                  <div class="info_cont">
                    <h4>BIDAN DESA</h4>
                    <p>Mon-Sun 8:30am-11:30pm</p>
                     <div class="center"><a style="background-color: <?php echo $n_color ?>;" class="btn main_bt" href="tel:<?php echo $key['n_kontak3']; ?>">HUBUNGI</a></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 adress_cont">
                <div class="information_bottom text_align_center">
                  <div class="icon_bottom"> <i class="fas fa-fire-alt"></i> </div>
                  <div class="info_cont">
                    <h4>KEBAKARAN</h4>
                    <p>24/7 online support</p>
                     <div class="center"><a style="background-color: <?php echo $n_color ?>;" class="btn main_bt" href="tel:<?php echo $key['n_kontak4']; ?>">HUBUNGI</a></div>
                  </div>
                </div>
              </div><br>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contant_form">
              <h4 class="text_align_center"><i class="fa fa-user"></i> Admin Website</h4>
              <div class="form_section">
                <form class="form_contant">
                  ...
                  <div class="row">
                    ...
                    <div class="center"><a style="background-color: <?php echo $n_color ?>;" class="btn main_bt" href="tel:<?php echo $key['n_kontak1']; ?>">HUBUNGI</a></div>
                  </div>
                  </fieldset>
                </form>
