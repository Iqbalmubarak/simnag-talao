  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-right">
        <div class="pull-left"><a class="btn sqaure_bt" href="index.php"><i class="fa fa-angle-left"></i> Kembali</a></div><br><br><br><br>
        <div class="full">
           <?php                           
          ...
          <div class="blog_section margin_bottom_0">
            <div class="blog_feature_img"> <img class="img-responsive" src="user/wisata/berita_img/<?php echo $key['b_image']; ?>" alt="#"> </div>
            <div class="blog_feature_cantant">

             

                <p class="blog_head"><?php echo $key['b_title']; ?></p>
                <div class="post_info">
                  <ul>
                    <li><i class="fa fa-user" aria-hidden="true"></i> <?php echo $key['b_author']; ?></li>
                    <li><i class="fa fa-circle" aria-hidden="true"></i> <?php echo $key['b_cat']; ?></li>
                    <li><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $key['b_date']; ?></li>
                  </ul>
                </div>
                <p><?php echo $key['b_message']; ?>
