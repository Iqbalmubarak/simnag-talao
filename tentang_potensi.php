        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Potensi Kekayaan Nagari</h1>
              <ol class="breadcrumb">
              </ol>
            </div>
          </div>
      ...
      <div class="col-md-9">
        <div class="row">
          <div class="col-md-12">
            <div class="full">
              <h2>VISI</h2>
              <p><img class="margin_bottom_30_all" src="images/it_service/struktur.png" alt="#"></p>
            </div>
          </div>
          <div class="col-md-12">
            <div class="full">
              <h2>MISI</h2>
              <p><a style="font-weight:bold;" >1.</a> Terwujudnya Kepribadian Masyarakat yang Agamis dan Berbudaya Mengedepankan Sistem Pendidikan Berbasis Surau<br><br>
                <a style="font-weight:bold;" >2.</a> Terwujudnya Pemerintahan Nagari yang Baik dan Bertanggungjawab dengan orientasi melayani<br><br>
                <a style="font-weight:bold;" >3.</a> Terwujudnya Pembangunan yang Partisipatif, Berkeadilan dan Terintegrasi dengan mengandalkan Program Masyarakat Manungga<br><br>
                <a style="font-weight:bold;" >4.</a> Terwujudnya Kemandirian Ekonomi dan Pemberdayaan Masyarakat Nagari dengan memprioritaskan Potensi Pertanian dan Wisata Lokal.<br>

                <a style="font-weight:bold;" >5.</a> Terwujudnya Lembaga dan Organisasi Nagari yang Kuat dan Berdaya Guna dengan Menciptakan Terobosan-terobosan baru.<br><br></p>
              </div>
            </div>
