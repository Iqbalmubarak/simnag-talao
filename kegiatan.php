          ...
          <div class="full">
            <div class="title-holder">
              <div class="title-holder-cell text-left">
                <h1 class="page-title">Kegiatan nagari</h1>
                <ol class="breadcrumb">
          ...
          ?>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_30_all">
              <div class="product_list">
                <div class="product_img"> <img class="img-responsive" <img src="user/wisata/kegiatan_img/<?php echo $row['k_image']; ?>" alt=""> </div>
                <div class="product_detail_btm">
                  <div class="center">
                    <h4><a href="it_shop_detail.php"><?php echo $row['k_title']; ?></a></h4>
                  </div>
                  <div class="starratin">
                    <div class="center" style="color:<?php echo $n_color ?>;"><?php echo $row['k_date']; ?></div>
                  </div>
                  <div class="product_price">
                    <p><span class=""><?php echo substr($row['k_message'],0,50); ?>...</span><br> <a class="btn sqaure_bt" href="kegiatan2.php?k_id=<?php echo $row['k_id']; ?>">Lihat</a></p>
                  </div>
                </div>
              </div>
            </div>
