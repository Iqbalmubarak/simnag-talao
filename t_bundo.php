        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">TAGEH BUNDO KANDUANG</h1>
              <ol class="breadcrumb">
                ...
                <div class="bs-example">
                  <div class="panel-group" id="accordion" style="margin-top:;">
                    <div class="panel panel-default">
                      <h3>Tentang TAGEH Bundo Kanduang</h3>
                      <img style="width: 800px; height:auto;" class="margin_bottom_30_all" src="images/it_service/tageh/tageh5.jpg" alt="#">
