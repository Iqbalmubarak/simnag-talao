                            ...
                            <div class="tab-pane active" id="list_view">
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0 c_table">
                                        ...
                                        <tbody>
                                            <?php
                                              while ($row = $sqlqueryresult3 ->fetch_assoc())
                                            {
                                            ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td><a href="a_arsip_folder_delete.php?folder_id=<?php echo $row['folder_id']; ?>" onclick="return confirm('Anda yakin untuk menghapus ?');" class="btn btn-danger btn-sm"><i style="color:white;" class="zmdi zmdi-hc-fw"></i></a></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
                ...
                <form id="form_validation" method="POST" action="a_arsip_folder_add_pro.php" method="POST" name="form1" onsubmit="return validation()">
                                ...
                                <div class="form-group">                                
                                    <input type="text" id="folder_name" name="folder_name" class="form-control" placeholder="Ketik nama folder baru">
                                     <input style="display:none;" type="text" id="folder_parent" name="folder_parent" class="form-control" placeholder="Ketik nama folder baru" value="0">
                                </div>
