                        ...
                        <div class="body">
                            <p>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_kk" name="p_kk" class="form-control" value="<?php echo $p_kk ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_nik" name="p_nik" class="form-control" value="<?php echo $p_nik ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
