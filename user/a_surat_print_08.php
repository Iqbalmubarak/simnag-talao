...
<body onload="window.print()">
  <?php                           
	foreach ($sqlqueryresult2 as $key) {
		...
		$s8_nama_saudara = $key['s8_nama_saudara'];
		$s8_nik_saudara = $key['s8_nik_saudara'];
		$s8_tempat_l_saudara = $key['s8_tempat_l_saudara'];
		$s8_tanggal_l_saudara = $key['s8_tanggal_l_saudara'];
		$s8_agama_saudara = $key['s8_agama_saudara'];
		$s8_kelamin_saudara = $key['s8_kelamin_saudara'];
		$s8_status_saudara = $key['s8_status_saudara'];
		$s8_pekerjaan_saudara = $key['s8_pekerjaan_saudara'];
		$s8_alamat_saudara = $key['s8_alamat_saudara'];
	} 
$p_jabatan=NULL;
$p_nama=NULL;
  ...
  <center>
          ...
          <td>
            <center>
              <font size="3"><U><b>SURAT KETERANGAN
                    BERSAUDARA</b></U></font><br>
              <font size="3">Nomor : 470/&emsp;&emsp;/WN.TSK/2021
              </font>
            </center>
          </td>
        </tr>
    ...
    <table width="625">
      <tr>
        <td>
          ...
          Kunyit Kecamatan Sangir Balai Janggo Kabupaten Solok Selatan
    ...
    <table width="625">
      <tr class="left">
        ...
        <td>:</td>
        <td width=70%><?php echo $s_p_name ; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td width="400"><?php echo $s_p_tempat_l ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Tanggal Lahir</td>
        <td>:</td>
        <td width="400"><?php echo $s_p_tanggal_l ; ?></td>
      </tr>
      <tr>
    ...
    <table width="625">
      <tr>
        <td>
          Adalah benar KEPONAKAN KANDUNG dengan nama yang tersebut
          dibawah ini :
        </td>
      </tr>
    </table>
    <table width="625">
      <tr class="left">
        <td>&emsp;&emsp;&emsp;Nama Lengkap </td>
        <td>:</td>
        <td width=70%><?php echo $s8_nama_saudara ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;NIK</td>
        <td>:</td>
        <td width="400"><?php echo $s8_nik_saudara ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Tempat Lahir</td>
        <td>:</td>
        <td width="400"><?php echo $s8_tempat_l_saudara ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Tanggal Lahir</td>
        <td>:</td>
        <td width="400"><?php echo $s8_tanggal_l_saudara ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Agama</td>
        <td>:</td>
        <td width="400"><?php echo $s8_agama_saudara ; ?>
        </td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Jenis Kelamin</td>
        <td>:</td>
        <td width="400"><?php echo $s8_kelamin_saudara ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Status</td>
        <td>:</td>
        <td width="400"><?php echo $s8_status_saudara ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Pekerjaan</td>
        <td>:</td>
        <td width="400"><?php echo $s8_pekerjaan_saudara ; ?></td>
      </tr>
      <tr>
        <td>&emsp;&emsp;&emsp;Alamat</td>
        <td>:</td>
        <td width="400"><?php echo $s8_alamat_saudara ; ?></td>
      </tr>
    </table>
    <table width="625">
      <tr>
        <td>
          Demikian keterangan bersaudara ini diberikan kepada yang
      ...
      <tr>
        ...
        <td width="300">
          <table>
            ...
            <tr>
              <td colspan="3"> <?php if($p_jabatan!=NULL){ echo $p_jabatan ;} ?>
              </td>
            </tr>
