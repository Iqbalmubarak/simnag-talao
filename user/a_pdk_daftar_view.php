...
$sqlquery2 = "SELECT * FROM daftar WHERE d_id='".$_GET["d_id"]."'";
...
<!doctype html>
    ...
    <section class="content">
            ...
            <div class="block-header">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Konfirmasi pendaftaran penduduk</h2>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <p>
                                ...
                                <form class="form-horizontal row-fluid" action="a_pdk_daftar_view_pro.php" method="POST" name="form3" onsubmit="return validation()" >
                                ...
                                foreach ($sqlqueryresult2 as $key) {
                                    ...
                                    $d_kk = $key['d_kk'];
                                    $d_name = $key['d_name'];
                                    $d_password = $key['d_password'];
                                    $d_kelamin = $key['d_kelamin'];
                                    $d_hub = $key['d_hub'];
                                    $d_fotokk = $key['d_fotokk'];
                                    $d_status = $key['d_status'];
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_name" name="p_name" class="form-control"   value="<?php echo $d_name ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="nokk" name="nokk" class="form-control" value="<?php echo $d_kk ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_nik" name="p_nik" class="form-control" value="<?php echo $d_nik ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_password" name="p_password" class="form-control" value="<?php echo $d_password ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix" style="display:none;">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_hub" name="p_hub" class="form-control" value="<?php echo $d_hub ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix" >
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Kelamin</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_kelamin" name="p_kelamin" class="form-control" value="<?php echo $d_kelamin ?>" placeholder="...." required readonly>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row clearfix" style="display:none" >
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_fotokkk" name="p_fotokkk" class="form-control" value="<?php echo $d_fotokk ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row clearfix" >
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Foto KK</label>
                                    </div>
                                    <div class="col-lg-8 col-md-10 col-sm-3">
                                        <div class="form-group">
                                             <iframe style="height:500px; width: 100%;" src="foto_kk/<?php echo $d_fotokk ?>" alt="#" /></iframe>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row clearfix" style="display:none;">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="d_idd" name="d_idd" class="form-control" value="<?php echo $d_id ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row clearfix" style="display:none;">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="d_status" name="d_status" class="form-control" value="2" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                 <input style="display:none" type="text"  id="notif_message" name="notif_message" class="form-control" value="Selamat, <?php echo $d_name ?> dengan nomor Kartu Keluarga ( <?php echo $d_kk ?> ), akun anda sudah terdaftar di dalam Akun SIMNagari." placeholder="...." required>
                                 <input style="display:none" type="text"  id="notif_title" name="notif_title" class="form-control" value="Data Penduduk" placeholder="...." required>
                                 <input style="display:none" type="text"  id="notif_logo" name="notif_logo" class="form-control" value="" placeholder="...." required>
                                 <input style="display:none" type="text"  id="notif_icon" name="notif_icon" class="form-control" value="bg-info" placeholder="...." required>
        ...
        <div class="col-sm-8 offset-sm-2">
            ...
            <a style="background-color: grey; font-weight:bold; " href="a_pdk_daftar.php" type="button" class="button btn login100-form-btn">KEMBALI</a>
            <a style="background-color: #04BE5B; font-weight:bold; font-size:12px;"  type="submit" href="javascript: submitform()" name="submit"  class="button btn login100-form-btn">APPROVE</a>
        </div>
