...
<body onload="window.print()">
	...
	foreach ($sqlqueryresult2 as $key) {
		...
		$s4_nama_usaha = $key['s4_nama_usaha'];
        ...
        <table width="625">
			<tr>
		       <td style="text-indent:50px;">
                Nama tersebut adalah benar memiliki usaha dibidang <b><?php echo $s4_nama_usaha ?></b> yang terletak di <b><?php echo $s_p_jorong ?></b> Kenagarian Talao Sungai Kunyit Kecamatan Sangir Balai Janggo Kabupaten Solok Selatan. 
		       </td>
		    </tr>
		</table>
        <table width="625">
			<tr>
		      <td style="text-indent:50px;">
                Demikian Surat Keterangan Usaha ini dikeluarkan, agar dapat dipergunakan sebagaimana mestinya. 
		       </td>
		    </tr>
		</table>
