...
$sqlquery3 = "SELECT folder_id FROM folder WHERE folder_id='".$_GET["folder_id"]."'";
...
<div class="content">
  ...
  <form action="a_arsip_file_form_pro.php" method="post" enctype="multipart/form-data">
    ...
    <input type="file" id="getFile" name="my_image2" placeholder="Your name.."><br><br>
                        ...
                        <?php                           
                         ...
                         <input style="display:none;" type="text" id="folder_idd" name="folder_idd" placeholder="Your last name.." value="<?php echo $folder_id ?>">
    <?php
                        }
                        ?>
  ...
  <?php                           
    while ($key=$sqlqueryresult7 -> fetch_assoc()) {
      ...
      ?>
                            <a type="button" href="a_arsip_file.php?folder_id=<?php echo $folder_idd ?>"><i class="zmdi zmdi-upload"></i> Close</a>
                            <?php
    }
    ?>
</div>
