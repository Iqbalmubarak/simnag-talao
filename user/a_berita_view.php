        ...
        <div class="menu">
            ...
            <li > <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Penduduk<div class="notify" ><span  class="heartbit"></span><span style="background-color:red;" class="point"></span></div></span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="a_pdk_lapor.php">Perubahan Data<div class="notify" ><span  class="heartbit"></span><span style="background-color:red;" class="point"></span></div></a></li>                
            ...
            <li class="active open"> <a href="javascript:void(4);" class="menu-toggle"><i class="zmdi zmdi-hc-fw"></i><span>SIMNagari</span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="a_berita_view.php">Berita</a></li> 
            ...
            <div class="block-header">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Data Berita</h2>
                        <ul class="breadcrumb">
                            <li><a style="background-color:#04BE5B;" href="wisata/index2.php" class="btn btn-primary waves-effect btn-lg"><i class="zmdi zmdi-hc-fw"></i>TAMBAH BERITA</a></li>
                                    ...
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        while ($row = $result2 ->fetch_assoc())
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['b_cat']; ?></td>
                                                <td><?php echo $row['b_title']; ?></td>
                                                <td><?php echo substr($row['b_message'],0,100); ?>.....</td>
                                                <td><?php echo $row['b_date']; ?></td>
                                                <td><img src="wisata/berita_img/<?php echo $row["b_image"];?>" width="250" height="150"></td>
                                                <td>
                                                    <a href="wisata/index2_update.php?b_id=<?php echo $row['b_id']; ?>" class="btn btn-default btn-sm"><i class="zmdi zmdi-eye"></i></a>
                                                   <a class="btn btn-default btn-sm" href="a_berita_view_delete.php?b_id=<?php echo $row['b_id']; ?>" onclick="return confirm('Anda yakin untuk menghapus ?');"><i class="zmdi zmdi-delete"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
