...
$sqlagama = "SELECT * FROM pn_agama WHERE pn_agama_id='".$_GET["pn_agama_id"]."'";
$sqlqueryagama = mysqli_query($connection,$sqlagama);
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <p>
                                ...
                                <form class="form-horizontal row-fluid" action="a_pn_agama_edit_pro.php" method="POST" name="form3" onsubmit="return validation()" ">
                                <?php                           
                                foreach ($sqlqueryagama as $key) {

                                    $pn_agama_id = $key['pn_agama_id'];
                                    $pn_agama_jor = $key['pn_agama_jor'];
                                    $pn_agama_1 = $key['pn_agama_1'];
                                    $pn_agama_2 = $key['pn_agama_2'];
                                    $pn_agama_3 = $key['pn_agama_3'];
                                     $pn_agama_4 = $key['pn_agama_4'];
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="pn_agama_id" name="pn_agama_id" class="form-control"  maxlength="16" value="<?php echo $pn_agama_id ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="pn_agama_jor" name="pn_agama_jor" class="form-control" value="<?php echo $pn_agama_jor ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Jumlah Muslim</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="pn_agama_1" name="pn_agama_1" class="form-control" value="<?php echo $pn_agama_1 ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Jumlah Kristen</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="pn_agama_2" name="pn_agama_2" class="form-control"  maxlength="16" value="<?php echo $pn_agama_2 ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Jumlah Buddha</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="pn_agama_3" name="pn_agama_3" class="form-control" value="<?php echo $pn_agama_3 ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Jumlah Hindu</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="pn_agama_4" name="pn_agama_4" class="form-control" value="<?php echo $pn_agama_4 ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
