...
<body class="theme-blush">
    ...
    <aside id="leftsidebar" class="sidebar">
        <div class="navbar-brand">
            ...
            <a href=""><img src="assets/images/KM_logo.png" style="width: 180px; height: auto;" width="25" alt="Aero"></a>
        </div>
        <div class="menu">
            <ul class="list">
                <li>
                    <div class="user-info">
                        <div class="detail">
                           ...
                           while ($key=$sqlqueryresult -> fetch_assoc()) {
                            $ad_name = $key['s_username'];
                            ?>

                            <div class="detail">
                                <a><?php echo $s_username ?></a>
            ...
            <li class="active open"><a href=""><i class="zmdi zmdi-hc-fw"></i><span>Edit Admin</span></a></li>
         ...
         <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-horizontal" action="super_admin_pro.php" method="POST" name="form1" onsubmit="return validation()">
                            
                           <div class="row clearfix">
                                <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                    <label for="email_address_2">Tambah Admin</label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="ad_email" name="ad_email" class="form-control" value="" placeholder="E-mail">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" id="ad_password" name="ad_password" class="form-control" value="" placeholder="Password">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        while ($row = $result2 ->fetch_assoc())
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <a href="super_admin_delete.php?ad_id=<?php echo $row['ad_id']; ?>" onclick="return confirm('Anda yakin untuk menghapus ?');" class="btn btn-default btn-sm"><i class="zmdi zmdi-delete"></i> Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
