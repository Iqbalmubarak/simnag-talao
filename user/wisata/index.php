	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="acontoh_pro.php" method="post" enctype="multipart/form-data" >
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="w_name" id="w_name" placeholder="Enter username">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">lokasi</span>
						<input class="input100" type="text" name="w_location" id="w_location" placeholder="Enter username">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Tentang</span>
						<textarea rows="15" class="input100" type="text" name="w_desc" id="w_desc" placeholder="Enter username"></textarea>
						<span class="focus-input100"></span>
					</div>
