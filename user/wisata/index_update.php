...
$sqlquery2 = "SELECT * FROM wisata WHERE w_id='".$_GET["w_id"]."'  ";
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="index_update_pro.php" method="POST" name="form3" onsubmit="return validation()" enctype="multipart/form-data" >
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Foto</span>
						<img src="wisata_img/<?php echo $w_image ?>" width="250" height="150">
						
					</div>
					<input style="display: none;" type="text" name="w_id" id="w_id" value="<?php echo $w_id ?>" >

					

					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Nama</span>
						<input class="input100" type="text" name="w_name" id="w_name" value="<?php echo $w_name ?>">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Lokasi</span>
						<input class="input100" type="text" name="w_location" id="w_location" value="<?php echo $w_location ?>">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<textarea rows="15" class="input100" type="text" name="w_desc" id="w_desc" value=""><?php echo $w_desc ?></textarea>
						<span class="focus-input100"></span>
					</div>
