...
<body onload="window.print()">
	...
	foreach ($sqlqueryresult2 as $key) {
		...
		$s5_p_name = $key['s5_p_name'];
		$s5_p_nik = $key['s5_p_nik'];
	}
...
?>
    ...
    <center>
            ...
            <tr>
                <td>
                    <center>
                        ...
                        <font size="3">Nomor : 510/&emsp;&emsp;/PEL/WN.TSK/2021</font>  
                    </center>
                </td>
            </tr>
		</table>
		...
		<table width="625">
			<tr>
		       <td>
			       <font size="2">Yang bertanda tangan dibawah ini Wali Nagari Talao Sungai Kunyit Kecamatan Sangir Balai Janggo Kabupaten Solok Selatan dengan ini menerangkan bahwa nama yang tertera di Sertifikat Badan Pertanahan Nasional atas nama :</font>
		       </td>
		</table>
		<!-- Database -->
		<table>
        ...
        <td width="50"></td>
				<td>Nama Lengkap</td>
        <td>:</td>
				<td width="541"> <b><?php echo $s5_p_name ?></b></td>
			</tr>
			<tr>
        <td width="50"></td>
				<td>No</td>
        <td>:</td>
				<td width="525"> <?php echo $s5_p_nik ?></td>
			</tr>
		</table>
    <!-- Database -->
    <table width="625">
			<tr>
		       <td>
			       <font size="2">Adalah orang yang sama dengan nama yang tertera di <b>Kartu Tanda Penduduk (KTP)</b> dan <b>Kartu Keluarga (KK)</b> atas nama :</font>
		       </td>
		    </tr>
		</table>
		</table>
      ...
      <!-- Database -->
		...
		<table width="625">
			<tr>
          <td>
            <font size="2">Demikian keterangan beda nama ini dibuat dengan sebenarnya agar dapat dipergunakan sebagaimana mestinya</font>
          </td>
		  </tr>
		</table>
