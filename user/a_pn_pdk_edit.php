...
$sqlpdk = "SELECT * FROM pn_pdk WHERE pn_pdk_id='".$_GET["pn_pdk_id"]."'";
$sqlquerypdk = mysqli_query($connection,$sqlpdk);
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <p>
                                ...
                                <form class="form-horizontal row-fluid" action="a_pn_pdk_edit_pro.php" method="POST" name="form3" onsubmit="return validation()" ">
                                <?php                           
                                foreach ($sqlquerypdk as $key) {

                                    $pn_pdk_id = $key['pn_pdk_id'];
                                    $pn_pdk_jor = $key['pn_pdk_jor'];
                                    $pn_pdk_pdk = $key['pn_pdk_pdk'];
                                    $pn_pdk_kk = $key['pn_pdk_kk'];
                                ...
                                <div class="row clearfix" style="display:none;">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="pn_pdk_id" name="pn_pdk_id" class="form-control"  maxlength="16" value="<?php echo $pn_pdk_id ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="pn_pdk_jor" name="pn_pdk_jor" class="form-control" value="<?php echo $pn_pdk_jor ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="pn_pdk_pdk" name="pn_pdk_pdk" class="form-control" value="<?php echo $pn_pdk_pdk ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Jumlah KK</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="pn_pdk_kk" name="pn_pdk_kk" class="form-control"  maxlength="16" value="<?php echo $pn_pdk_kk ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
