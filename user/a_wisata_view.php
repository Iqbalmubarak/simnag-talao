        ...
        <div class="menu">
            ...
            <li class="active open"> <a href="javascript:void(4);" class="menu-toggle"><i class="zmdi zmdi-hc-fw"></i><span>SIMNagari</span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="a_wisata_view.php">Wisata</a></li>
            ...
            <div class="block-header">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                         <h2>Data Wisata</h2>
                        <ul class="breadcrumb">
                            <li><a style="background-color:#04BE5B;" href="wisata/index.php" class="btn btn-primary waves-effect btn-lg"><i class="zmdi zmdi-hc-fw"></i>TAMBAH WISATA</a></li>
                                    ...
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        while ($row = $sqlqueryresult2 ->fetch_assoc())
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo substr($row['w_desc'],0,100); ?>.....</td>
                                                <td><img src="wisata/wisata_img/<?php echo $row["w_image"];?>" width="250" height="150"></td>
                                                
                                                <td>
                                                    <a href="wisata/index_update.php?w_id=<?php echo $row['w_id']; ?>" class="btn btn-default btn-sm"><i class="zmdi zmdi-eye"></i></a>
                                                   <a class="btn btn-default btn-sm" href="a_wisata_view_delete.php?w_id=<?php echo $row['w_id']; ?>" onclick="return confirm('Anda yakin untuk menghapus ?');"><i class="zmdi zmdi-delete"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
