...
$sqlquery2 = "SELECT * FROM perantau WHERE per_id='".$_GET["per_id"]."'";
...
<!doctype html>
        ...
        <div class="menu">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Penduduk<div class="notify" ><span  class="heartbit"></span><span style="background-color:red;" class="point"></span></div></span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="a_perantau.php">Perantau</a></li>
    ...
    <section class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <p>
                                ...
                                <form class="form-horizontal row-fluid" action="a_perantau_view_pro.php" method="POST" name="form3" onsubmit="return validation()" ">
                                <?php                           
                                foreach ($sqlqueryresult2 as $key) {

                                    $per_id = $key['per_id'];
                                    $per_nik = $key['per_nik'];
                                    $per_name = $key['per_name'];
                                    $per_pek = $key['per_pek'];
                                    $per_address = $key['per_address'];
                                    $per_country = $key['per_country'];
                                    $per_prov = $key['per_prov'];
                                    $per_wa = $key['per_wa'];
                                ...
                                <div class="row clearfix" style="display:none;">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_idd" name="per_idd" class="form-control"  maxlength="16" value="<?php echo $per_id ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_nik" name="per_nik" class="form-control"  maxlength="16" value="<?php echo $per_nik ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_name" name="per_name" class="form-control"  maxlength="16" value="<?php echo $per_name ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_pek" name="per_pek" class="form-control"  maxlength="16" value="<?php echo $per_pek ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_address" name="per_address" class="form-control"  maxlength="16" value="<?php echo $per_address ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">Negara</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_country" name="per_country" class="form-control"  maxlength="16" value="<?php echo $per_country ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_prov" name="per_prov" class="form-control"  maxlength="16" value="<?php echo $per_prov ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                        <label for="email_address_2">No WA</label>
                                    </div>
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="per_wa" name="per_wa" class="form-control"  maxlength="16" value="<?php echo $per_wa ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-sm-8 offset-sm-2">
            ...
            <a style="background-color: grey; font-weight:bold; " href="a_perantau.php" type="button" class="btn btn-raised btn-primary btn-round waves-effect">KEMBALI</a>
