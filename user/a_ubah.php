        ...
        <div class="menu">
            ...
            <li class="active open" > <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Penduduk<div class="notify" ><span  class="heartbit"></span><span style="background-color:red;" class="point"></span></div></span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="a_ubah.php">Perubahan Data<div class="notify" ><span  class="heartbit"></span><span style="background-color:red;" class="point"></span></div></a></li>                
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="alert alert-danger" style="background-color:#ee2558;">
                                <a style="text-align: center; "><strong>Halaman Masih dalam proses pengerjaan !</strong></a>
                            </div>
