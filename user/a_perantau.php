...
$sqlquery2 = "SELECT * FROM perantau
                                    ...
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        while ($row = $result2 ->fetch_assoc())
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['per_nik']; ?></td>
                                                <td><?php echo $row['per_name']; ?></td>
                                                <td><?php echo $row['per_pek']; ?></td>
                                                <td><?php echo $row['per_address']; ?></td>
                                                <td><?php echo $row['per_country']; ?></td>
                                                <td><?php echo $row['per_wa']; ?></td>
                                                
                                                <td> 
                                                    <a href="a_perantau_view.php?per_id=<?php echo $row['per_id']; ?>" class="btn btn-default btn-sm"><i class="zmdi zmdi-eye"></i></a>
                                                    <a href="a_per_delete.php?per_id=<?php echo $row['per_id']; ?>" onclick="return confirm('Anda yakin untuk menghapus ?');" class="btn btn-default btn-sm"><i class="zmdi zmdi-delete"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
