...
$sqlquery2 = "SELECT * FROM kegiatan
ORDER BY k_id DESC";
        ...
        <div class="menu">
            ...
            <li class="active open"> <a href="javascript:void(4);" class="menu-toggle"><i class="zmdi zmdi-hc-fw"></i><span>SIMNagari</span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="a_keg_view.php">P. Kekayaan</a></li>                        
                </ul>
            </li>
            ...
            <div class="block-header">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Data Potensi Kekayaan Nagaru</h2>
                        <ul class="breadcrumb">
                            <li><a style="background-color:#04BE5B;" href="wisata/index3.php" class="btn btn-primary waves-effect btn-lg"><i class="zmdi zmdi-hc-fw"></i>TAMBAH Potensi Kekayaan</a></li>
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        <tbody>
                                            <?php
                                        while ($row = $sqlqueryresult2 ->fetch_assoc())
                                        {
                                            ?>

                                            <tr>
                                                <td><?php echo $row['k_id']; ?></td>
                                                <td><?php echo $row['k_title']; ?></td>
                                                <td><?php echo $row['k_date']; ?></td>
                                                <td><?php echo substr($row['k_message'],0,100); ?>.....</td>
                                                <td><img src="wisata/kegiatan_img/<?php echo $row["k_image"];?>" width="250" height="150"></td>
                                                
                                                <td>
                                                    <a href="wisata/index3_update.php?k_id=<?php echo $row['k_id']; ?>" class="btn btn-default btn-sm"><i class="zmdi zmdi-eye"></i></a>
                                                   <a class="btn btn-default btn-sm" href="a_keg_view_delete.php?k_id=<?php echo $row['k_id']; ?>" onclick="return confirm('Anda yakin untuk menghapus ?');"><i class="zmdi zmdi-delete"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
