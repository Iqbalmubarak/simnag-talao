        ...
        <div class="block-header">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                     ...
                     <ul class="breadcrumb">
                            <li><a style="background-color:#04BE5B;" href="a_pdk_add.php" class="btn btn-primary waves-effect btn-lg"><i class="zmdi zmdi-hc-fw"></i>TAMBAH </a></li>
                            &nbsp;
                             
                             <li><a style="background-color:grey;" href="a_pdk_view.php"  class="btn btn-primary waves-effect btn-lg"><i class="zmdi zmdi-hc-fw"></i> VIEW</a></li>
                        </ul>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="alert alert-danger">
                                <a style="text-align: center; "><strong>KEPALA KELUARGA</strong></a>
                            </div>
                                   ...
                                   <tbody>
                                    ...
                                    while ($row = $result2 ->fetch_assoc())
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['p_kk']; ?></td>
                                            <td><?php echo $row['p_nik']; ?></td>
                                            <td><?php echo $row['p_name']; ?></td>
                                            <td><?php echo $row['p_l_tanggal']; ?></td>
                                            <td><?php echo $row['p_l_tempat']; ?></td>
                                            <td><?php echo $row['p_hub']; ?></td>
                                            <td>
                                                <a href="a_pdk_view_edit.php?p_kk=<?php echo $row['p_kk']; ?>" class="btn btn-default btn-sm"><i class="zmdi zmdi-eye"></i></a>

                                                <a class="btn btn-default btn-sm" href="a_pdk_view_delete.php?p_kk=<?php echo $row['p_kk']; ?>" onclick="return confirm('Anda yakin untuk menghapus ?');"><i class="zmdi zmdi-delete"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
