            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <h2><i class="zmdi zmdi-hc-fw"></i> Surat Keterangan Beda Nama</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="body"><br>
                                ...
                                <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-primary"><br><br><br><br><br><br>
                                        <form class="form-horizontal row-fluid" action="simnag_surat_05_pro.php"
                                            ...
                                            <center>
                                                ...
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <center>
                                                                <font size="3"><U><b>SURAT KETERANGAN BEDA NAMA</b></U>
                                                                </font><br>
                                                ...
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <font size="2">Yang bertanda tangan dibawah ini Wali Nagari
                                                                Talao Sungai Kunyit Kecamatan Sangir Balai Janggo
                                                                Kabupaten Solok Selatan dengan ini menerangkan bahwa
                                                                nama yang tertera di Sertifikat Badan Pertanahan
                                                                Nasional atas nama :</font>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <br>
                                                ...
                                                <table>
                                                    <tr class="text2">
                                                        ...
                                                        <td>Nama Lengkap</td>
                                                        <td>:</td>
                                                        <td width="541"> <b><input
                                                                    class="form-control col-sm-8 show-tick ms select2"
                                                                    type="text" id="s5_p_name" name="s5_p_name"></b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="50"></td>
                                                        ...
                                                        <td width="525"> <input
                                                                class="form-control col-sm-8 show-tick ms select2"
                                                                type="text" id="s5_p_nik" name="s5_p_nik"></td>
                                                    </tr>
                                                </table>
                                                <!-- Database -->
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <font size="2">Adalah orang yang sama dengan nama yang
                                                                tertera di <b>Kartu Tanda Penduduk (KTP)</b> dan
                                                                <b>Kartu Keluarga (KK)</b> atas nama :</font>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- Database -->
                                                ...
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <font size="2">Demikian keterangan beda nama ini dibuat
                                                                dengan sebenarnya agar dapat dipergunakan sebagaimana
                                                                mestinya</font>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <input style="display: none;" type="text" id="s_title" name="s_title"
                                                class="form-control col-sm-3" value="Surat Keterangan Beda Nama">
                                            ...
                                            <input style="display: none;" type="text" id="s_filepath" name="s_filepath"
                                                class="form-control col-sm-3" value="a_surat_print_05.php">
