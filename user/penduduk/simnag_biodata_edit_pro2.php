...
require_once('../db_connect.php');
  ...
  $p_nik= $_POST["p_nik"];
  $p_password2= $_POST["p_password22"];
  $p_name= $_POST["p_name"];
...
$sql2 = "UPDATE login SET p_password='$p_password2' WHERE p_kk='$p_kk'";
...
{ 
    ...
    echo '<script type="text/javascript">alert("'.$msg2.'");</script>';
    echo "<meta http-equiv=\"refresh\" content=\"0; url=simnag_biodata.php?p_kk='".$_POST["p_kk"]."'\">";
}
