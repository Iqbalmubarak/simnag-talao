            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <h2><i class="zmdi zmdi-hc-fw"></i> Surat Rekomendasi KK</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="body"><br>
                                ...
                                <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-primary"><br><br><br><br><br><br>
                                        <form class="form-horizontal row-fluid" action="simnag_surat_02_pro.php"
                                            ...
                                            <center>
                                                ...
                                                <table width="625">
                                                    <tr class="text2">
                                                        <td>Nomer</td>
                                                        <td widht="100">: 476/&emsp;/Kepend/WN.TSK 2021</td>
                                                        <td widht="500">Talao, <?php echo date("d F Y", $d) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Lamp</td>
                                                        <td width="564">: -</td>
                                                ...
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <font size="2">&nbsp &nbsp &nbsp &nbsp Bersama ini kami
                                                                Mohon Bapak kiranya dapat membuatkan <b>Kartu Keluarga
                                                                    (KK)</b> baru kepada Warga kami yang tersebut
                                                                dibawah ini :</font>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table width="625">
                                                    <tr>
                                                        ...
                                                        <td class="text" align="center">
                                                            a.n PJ Wali Nagari Talao Sungai Kunyit Sekretaris
                                                            Nagari<br><br><br><br><b><u>AFRIWES, M.Pd.I</u></b>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </center><br><br>
                                            ...
                                            <input style="display: none;" type="text" id="s_title" name="s_title"
                                                class="form-control col-sm-3" value="Surat Rekomendasi KK">
                                            ...
                                            <input style="display: none;" type="text" id="s_filepath" name="s_filepath"
                                                class="form-control col-sm-3" value="a_surat_print_02.php">


                                            <input style="display:none" type="text" id="notif_message"
                                                name="notif_message" class="form-control"
                                                value="Permohonan cetak surat ( Surat Pembuatan KK ) sedang di proses oleh operator nagari. Proses akan dilakukan selama 1-2 hari. Terima Kasih"
