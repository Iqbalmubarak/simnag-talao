...
ON lapor.l_pelaporkk=penduduk.p_kk WHERE penduduk.p_kk='$p_kk' AND lapor.l_anonim='2' ORDER BY l_date2 DESC";
...
$sqlquery3 = "SELECT * FROM surat
WHERE s_p_kk='$p_kk' ORDER BY s_made DESC";
...
<body class="theme-blush">
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            ...
            <li  class="active open" ><a href="simnag_status.php"><i class="zmdi zmdi-hc-fw"></i><span>Status</span></a></li>
...
<img style="width: 100%; height: auto;" src="../assets/images/ok3.png">
                                ...
                                <table class="table table-hover c_table">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $sqlqueryresult ->fetch_assoc())
                                        {
                                            ?>
                                            <tr>
                                                <td><strong><?php echo $row['l_pelapornik']; ?></strong></td>
                                                <td><?php echo $row['l_type']; ?></td>
                                                <td><?php echo substr($row['l_message'],0,50); ?></td>
                                                <td><?php echo $row['l_date2']; ?></td>

                                                <td >
                                                    
                                                   <span class="badge <?php echo $row['l_badge']; ?>"><?php echo $row['l_status']; ?></span>
                                                </a>
                                            </div>
                                        </td>
                                        </tr>
            ...
            <div class="block-header">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>B. Status Permohonan Cetak Surat</h2>
                            ...
                            <table class="table table-hover c_table">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result3 ->fetch_assoc())
                                    {
                                        ?>
                                    <tr>
                                        <td><strong><?php echo $row['s_p_nik']; ?></strong></td>
                                        <td><a title=""><?php echo $row['s_title']; ?></a></td>
                                        <td><?php echo $row['s_made']; ?></td>
                                        <td><span class="badge <?php echo $row['s_badge']; ?>"><?php echo $row['s_status']; ?></span></td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
