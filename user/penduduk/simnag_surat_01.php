                            ...
                            <div class="body"><br>
                                ...
                                <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-primary"><br><br><br><br><br><br>
                                        <form class="form-horizontal row-fluid" action="simnag_surat_01_pro.php"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <font size="2">&nbsp &nbsp &nbsp &nbsp Bersama ini kami
                                                                Mohon Bapak kiranya dapat membuat <b>Elektronik Kartu
                                                                    Tanda Penduduk (E-KTP)</b> kepada Warga kami yang
                                                                tersebut dibawah ini :</font>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <br>
                                            ...
                                            <input style="display: none;" type="text" id="s_title" name="s_title"
                                                class="form-control col-sm-3" value="Surat Rekomendasi e-KTP">
                                            ...
                                            <input style="display: none;" type="text" id="s_filepath" name="s_filepath"
                                                class="form-control col-sm-3" value="a_surat_print_01.php">


                                            <input style="display:none" type="text" id="notif_message"
                                                name="notif_message" class="form-control"
                                                value="Permohonan cetak surat ( Surat Rekomendasi e-KTP ) sedang di proses oleh operator nagari. Proses akan dilakukan selama 1-2 hari. Terima Kasih"
