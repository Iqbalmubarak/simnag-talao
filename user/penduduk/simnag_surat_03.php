            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <h2><i class="zmdi zmdi-hc-fw"></i> Surat Berdomisili</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="body"><br>
                                ...
                                <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-primary"><br><br><br><br><br><br>
                                        <form class="form-horizontal row-fluid" action="simnag_surat_03_pro.php"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="625">
                                                                <tr>
                                                                    <td>
                                                                        Adalah benar berdomisili di <b>Jorong Talao</b>,
                                                                        Nagari Talao Sungai Kunyit Kecamatan Sangir
                                            ...
                                            <input style="display: none;" type="text" id="s_title" name="s_title"
                                                class="form-control col-sm-3" value="Surat Berdomisili">
                                            ...
                                            <input style="display: none;" type="text" id="s_filepath" name="s_filepath"
                                                class="form-control col-sm-3" value="a_surat_print_03.php">


                                            <input style="display:none" type="text" id="notif_message"
                                                name="notif_message" class="form-control"
                                                value="Permohonan cetak surat ( Surat Berdomisili ) sedang di proses oleh operator nagari. Proses akan dilakukan selama 1-2 hari. Terima Kasih"
