                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                ...
                                <form class="form-horizontal row-fluid" action="simnag_biodata_edit_pro2.php" method="POST" name="form3" onsubmit="return validation()" ">
                                <?php                           
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_kk" readonly name="p_kk" class="form-control" value="<?php echo $p_kk ?>" placeholder="" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_password22" name="p_password22" class="form-control" value="<?php echo $p_password ?>" placeholder="" required>
                                        </div>
                                    </div>
                                </div><br><br>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_nik" name="p_nik" class="form-control" value="<?php echo $p_nik ?>" placeholder="s" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="input-group col-md-3">
                                    ...
                                    <input type="text" class="form-control datepicker" id="p_l_tanggal" name="p_l_tanggal" value="<?php echo $p_l_tanggal ?>" placeholder="Belum di isi.." required>
                                </div>
                            </div><br><br>
