            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Cetak Surat Rekomendasi Pindah</h2>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane in active">
                                            <p>
                                                ...
                                                <form class="form-horizontal row-fluid" action="simnag_surat_07_pro.php" method="POST"
                                                    name="form3" onsubmit="return validation()">
                                                    <center>
                                                        <table>
                                                            <tr>
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="525"><input class="form-control col-sm-5"
                                                                        ...
                                                                        name="s_p_tempat_l"
                                                                        value="<?php echo $p_l_tempat ; ?>" readonly>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="50"></td>
                                                                ...
                                                                <td width="525"><input class="form-control col-sm-5"
                                                                        ...
                                                                        name="s_p_tanggal_l"
                                                                        value="<?php echo $p_l_tanggal ; ?>" readonly>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="50"></td>
                                                                ...
                                                                <td>:</td>
                                                                <td width="525"><input class="form-control col-sm-5"
                                                                        type="text" id="s_p_kelamin" name="s_p_kelamin"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td width="525"><input class="form-control col-sm-5"
                                                                        type="text" id="s_p_agama" name="s_p_agama"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_kelurahan"
                                                                                    name="s7_kelurahan"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Kecamatan </td>
                                                                            <td>:</td>
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_kecamatan"
                                                                                    name="s7_kecamatan"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Kabupaten </td>
                                                                            <td>:</td>
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_kabupaten"
                                                                                    name="s7_kabupaten"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Provinsi </td>
                                                                            <td>:</td>
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_provinsi"
                                                                                    name="s7_provinsi"></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                ...
                                                                <td width="525">
                                                                    <table
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:</td>
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_p_kelurahan"
                                                                                    name="s7_p_kelurahan"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Kecamatan </td>
                                                                            <td>:</td>
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_p_kecamatan"
                                                                                    name="s7_p_kecamatan"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Kabupaten </td>
                                                                            <td>:</td>
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_p_kabupaten"
                                                                                    name="s7_p_kabupaten"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Provinsi </td>
                                                                            <td>:</td>
                                                                            <td><input class="form-control col-sm-5"
                                                                                    type="text" id="s7_p_provinsi"
                                                                                    name="s7_p_provinsi"></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="525">
                                                                    <textarea class="form-control col-sm-5" type="text"
                                                                        id="s7_p_alasan" name="s7_p_alasan"> </textarea>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="50"></td>
                                                        ...
                                                        <table width="625">
                                                            <tr>
                                                                ...
                                                                <td class="text" align="center">
                                                                    Pj Wali Nagari Talao Sungai
                                                                    Kunyit<br><br><br><br><b><u>PURWANTO</u></b>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </center>
                                                    ...
                                                    <input style="display: none;" type="text" id="s_title"
                                                        ...
                                                        value="Surat Rekomendasi Pindah">
                                                    ...
                                                    <input style="display: none;" type="text" id="s_filepath"
                                                        ...
                                                        value="a_surat_print_07.php">


                                                    <input style="display:none" type="text" id="notif_message"
                                                        name="notif_message" class="form-control"
                                                        value="Permohonan cetak surat ( Surat Keterangan Beda Nama ) sedang di proses oleh operator nagari. Proses akan dilakukan selama 1-2 hari. Terima Kasih"
