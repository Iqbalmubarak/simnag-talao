            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <h2><i class="zmdi zmdi-hc-fw"></i> Surat Keterangan Meninggal Dunia</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="body"><br>
                                ...
                                <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-primary"><br><br><br><br><br><br>
                                        <form class="form-horizontal row-fluid" action="simnag_surat_06_pro.php"
                                            ...
                                            <center>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center>
                                                                ...
                                                                <font size="2">Alamat : Jalan Raya Talao</font>
                                                                &emsp;&emsp;&emsp;
                                                                <font size="2">E-mail : talaooke@gmail.com</font>
                                                                &emsp;&emsp;&emsp;
                                                    ...
                                                    <table width="625">
                                                        <tr>
                                                            <td>
                                                                <center>
                                                                    <font size="4"><U><b>SURAT KETERANGAN MENINGGAL
                                                                                DUNIA</b></U></font><br>
                                                                    <font size="3">Nomor :
                                                                        470/&emsp;&emsp;/Kepend/WN.TSK/2021</font>
                                                                </center>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <p style="text-indent:50px;">Yang bertanda tangan dibawah
                                                                ini Wali Nagali Talao Sungai Kunyit Kecamatan Sangir
                                                                Balai
                                                                Janggo Kabupaten Solok Selatan dengan ini menerangkan
                                                                bahwa:
                                                            </p>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table width="625">
                                                    <tr class="left">
                                                        ...
                                                        <td>:</td>
                                                        <td width=70%><input class="form-control col-sm-5" type="text" id="s_p_name" name="s_p_name" value="<?php echo $p_name ; ?>" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Tempat Lahir</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s_p_tempat_l" name="s_p_tempat_l" value="<?php echo $p_l_tempat ; ?>" readonly></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Tanggal Lahir</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s_p_tanggal_l" name="s_p_tanggal_l" value="<?php echo $p_l_tanggal ; ?>" readonly></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Jenis Kelamin</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s_p_kelamin" name="s_p_kelamin" value="<?php echo $kelamin ; ?>" readonly></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Agama</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s_p_agama" name="s_p_agama" value="<?php echo $agama ; ?>" readonly></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Alamat</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s_p_alamat" name="s_p_alamat" value="<?php echo $p_alamat ; ?>" readonly></td>
                                                    </tr>
                                                    </font>
                                                </table>
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <p style="text-indent:50px;">Yang mana nama tersebut telah
                                                ...
                                                <table width="625">
                                                    <tr class="left">
                                                        ...
                                                        <td>:</td>
                                                        <td width=70%><input class="form-control col-sm-5" type="text" id="s6_hari" name="s6_hari"></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Tanggal</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="date" id="s6_tanggal" name="s6_tanggal"></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Jam</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s6_jam" name="s6_jam"></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Tempat</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s6_tempat" name="s6_tempat"></td>
                                                    </tr>
                                                    <tr class="left">
                                                        <td>&emsp;&emsp;&emsp;Meninggal karena</td>
                                                        <td>:</td>
                                                        <td><input class="form-control col-sm-5" type="text" id="s6_alasan" name="s6_alasan"></td>
                                                    </tr>
                                                    </font>
                                                </table>
                                                <table width="625">
                                                    <tr>
                                                        <td>
                                                            <p style="text-indent:50px;">Demikian Surat Keterangan
                                                                Meninggal Dunia ini dibuat, untuk dapat dipergunakan
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="300">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td colspan="3">a.n Pj Wali Nagari Talao Sungai
                                                                        kunyit</td>
                                                                </tr>
                                                                <tr>
                                            ...
                                            <input style="display: none;" type="text" id="s_title" name="s_title"
                                                class="form-control col-sm-3" value="Surat Keterangan Meninggal Dunia">
                                            ...
                                            <input style="display: none;" type="text" id="s_filepath" name="s_filepath"
                                                class="form-control col-sm-3" value="a_surat_print_06.php">


                                            <input style="display:none" type="text" id="notif_message"
                                                name="notif_message" class="form-control"
                                                value="Permohonan cetak surat ( Surat Keterangan Meninggal Dunia ) sedang di proses oleh operator nagari. Proses akan dilakukan selama 1-2 hari. Terima Kasih"
