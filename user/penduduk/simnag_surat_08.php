                            ...
                            <div class="body"><br>
                                ...
                                <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-primary"><br><br><br><br><br><br>
                                        <form class="form-horizontal row-fluid" action="simnag_surat_08_pro.php"
                                            ...
                                            <center>
                                                ...
                                                <table width="625">
                                                    <tr class="left">
                                                        ...
                                                        <td>:</td>
                                                        <td width=70%><input class="form-control col-sm-5" type="text"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td width="400"><input class="form-control col-sm-5" type="text"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td width="400"><input class="form-control col-sm-5" type="text"
                                                                id="s_p_kelamin" name="s_p_kelamin"
                                                ...
                                                <table width="625">
                                                    <tr class="left">
                                                        ...
                                                        <td>:</td>
                                                        <td width=70%><input class="form-control col-sm-5" type="text"
                                                                id="s8_nama_saudara" name="s8_nama_saudara"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&emsp;&emsp;&emsp;NIK</td>
                                                        <td>:</td>
                                                        <td width="400"><input class="form-control col-sm-5" type="text"
                                                                id="s8_nik_saudara" name="s8_nik_saudara"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&emsp;&emsp;&emsp;Tempat Lahir</td>
                                                        <td>:</td>
                                                        <td width="400"><input class="form-control col-sm-5" type="text"
                                                                id="s8_tempat_l_saudara" name="s8_tempat_l_saudara">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>&emsp;&emsp;&emsp;Tanggal Lahir</td>
                                                        <td>:</td>
                                                        <td width="400"><input class="form-control col-sm-5" type="date"
                                                                id="s8_tanggal_l_saudara" name="s8_tanggal_l_saudara">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>&emsp;&emsp;&emsp;Agama</td>
                                                        <td>:</td>
                                                        <td width="400"><input class="form-control col-sm-5" type="text"
                                                                id="s8_agama_saudara" name="s8_agama_saudara"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>&emsp;&emsp;&emsp;Jenis Kelamin</td>
                                                        <td>:</td>
                                                        <td width="400"><select
                                                                class="form-control col-sm-5 show-tick ms select2"
                                                                id="s8_kelamin_saudara" name="s8_kelamin_saudara"
                                                                data-placeholder="Select">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="400"><select
                                                                class="form-control col-sm-5 show-tick ms select2"
                                                                id="s8_status_saudara" name="s8_status_saudara"
                                                                data-placeholder="Select">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td width="400"><input class="form-control col-sm-5" type="text"
                                                                id="s8_pekerjaan_saudara" name="s8_pekerjaan_saudara">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>&emsp;&emsp;&emsp;Alamat</td>
                                                        <td>:</td>
                                                        <td width="400"><textarea class="form-control col-sm-5"
                                                                type="text" id="s8_alamat_saudara"
                                                                name="s8_alamat_saudara"> </textarea></td>
                                                    </tr>
                                                </table>
                                                <table width="625">
                                                    <tr>
                                            ...
                                            <input style="display: none;" type="text" id="s_title" name="s_title"
                                                class="form-control col-sm-3" value="Surat Keterangan Bersaudara">
                                            ...
                                            <input style="display: none;" type="text" id="s_filepath" name="s_filepath"
                                                class="form-control col-sm-3" value="a_surat_print_08.php">
