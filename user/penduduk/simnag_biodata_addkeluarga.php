                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane in active" >
                                    <p>
                                        ...
                                        <form class="form-horizontal row-fluid" action="simnag_biodata_addkeluarga_pro.php?p_kk=<?php echo $p_kk ?>" method="POST" name="form1" onsubmit="return validation()">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-3 col-md-10 col-sm-3">
                                                    <div class="form-group">
                                                        <input type="text" id="nokk" readonly name="nokk" class="form-control" value="<?php echo $key['p_kk']; ?>" placeholder="Enter your email address" required  maxlength="16"> 
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-3 col-md-10 col-sm-3">
                                                    <div class="form-group">
                                                        <input type="text" id="k_nik2" readonly name="k_nik2" class="form-control" value="<?php echo strtoupper($rand); ?>" placeholder="Enter your email address" required  maxlength="16"> 
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row clearfix" style="display:none">
                                                ...
                                                <div class="col-lg-3 col-md-10 col-sm-3">
                                                    <div class="form-group">
                                                        <input type="text"  id="k_password" name="k_password" class="form-control"  placeholder="....." required>
                                                    </div>
                                                </div>
                                            </div><br><br>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-3 col-md-10 col-sm-3">
                                                    <div class="form-group">
                                                        <input type="text" id="k_nik" name="k_nik" class="form-control"  placeholder="....." required  maxlength="16">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="controls " style="display:none">
                                                ...
                                                <input class="myRadio" id="yes" type="radio" name="gender" value="Belum Punya" oninput="generateFullName5()">Belum Punya
                                                <script type="text/javascript">
                                                    function generateFullName5()
                                                    {
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-2 col-md-2 col-sm24 form-control-label">
                                                    <label for="email_address_2">No Telp</label>
                                                </div>
                                                <div class="col-lg-3 col-md-10 col-sm-3">
                                                    <div class="form-group">
