...
if(isset($_POST['submit']))
{
    ...
    $query=mysqli_query($connection, "SELECT max(b_id) as b_id from berita");
    $result=mysqli_fetch_array($query);
    $b_id=$result['b_id']+1;
    $dir="berita_img/$b_id";
    mkdir($dir);
    
    move_uploaded_file($_FILES['b_image']['tmp_name'], "berita_img/$b_id/".$_FILES["b_image"]["name"]);

    $sql=mysqli_query($connection, "INSERT INTO berita (b_image, b_cat, b_title, b_message, b_date, b_author) VALUES ('$b_image','$b_cat','$b_title', '$b_message','$b_date','$b_author' )");
}
        ...
        <div class="menu">
            ...
            <li> <a href="javascript:void(4);" class="menu-toggle"><i class="zmdi zmdi-hc-fw"></i><span>SIMNagari</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="a_datanagari.php">Data Nagari</a></li>
        ...
        <div class="block-header">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Tambah Berita</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href=""><i class="zmdi zmdi-home"></i>Beranda</a></li>
         ...
         <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-horizontal" action="a_berita_add_pro.php" method="POST" name="form1" onsubmit="return validation()">
                            <div class="col-lg-6 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <input type="file" name="b_image" id="b_image" class="dropify">
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="b_cat" name="b_cat" class="form-control" value="">
                                    </div>
                                </div>
                            </div><div class="row clearfix">
                                <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                    <label for="email_address_2">Judul</label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="b_title" name="b_title" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                    <label for="email_address_2">Berita</label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <textarea rows="10" class="form-control no-resize" id="b_message" name="b_message" placeholder="Please type what you want..."></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                    <label for="email_address_2">Nama Penulis</label>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="b_author" name="b_author" class="form-control" value="Fulan Binti FUlan">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix" style="display:none;">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <input type="text" id="b_date" name="b_date" class="form-control" value="<?php date_default_timezone_set("Asia/jakarta"); echo date('j/n/Y'); ?> <?php date_default_timezone_set("Asia/Jakarta"); echo date('h:i:s A'); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8">
                                    <div class="form-group">
                                        <label for="email_address_2" style="font-style: italic;"><?php date_default_timezone_set("Asia/jakarta"); echo date('j/n/Y'); ?> <?php date_default_timezone_set("Asia/Jakarta"); echo date('h:i:s A'); ?></label>
                                    </div>
                                </div>
                            </div>
