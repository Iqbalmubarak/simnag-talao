...
$sqlquery2 = "SELECT * FROM penduduk WHERE p_kk='".$_GET["p_kk"]."'";
    ...
    <section class="content">
            ...
            <div class="block-header">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Edit Data Penduduk ( Kepala Keluarga )</h2>
                        <ul class="breadcrumb">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <p>
                                ...
                                <form class="form-horizontal row-fluid" action="a_pdk_view_edit_pro.php" method="POST" name="form3" onsubmit="return validation()" ">
                                <?php                           
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_kk" name="p_kk" class="form-control"  maxlength="16" value="<?php echo $p_kk ?>" placeholder="Enter your email address" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix" style="display:none">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_id" name="p_id" class="form-control" value="<?php echo $p_id ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text"  id="p_password" name="p_password" class="form-control" value="<?php echo $p_password ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div><br><br>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_nik" name="p_nik" class="form-control"  maxlength="16" value="<?php echo $p_nik ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-10 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="p_hub" readonly name="p_hub" class="form-control" value="<?php echo $p_hub ?>" placeholder="...." required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-10 col-sm-3">
                                    <div class="form-group">
                                        <input type="text"  id="p_l_tempat" name="p_l_tempat" class="form-control" value="<?php echo $p_l_tempat ?>" placeholder="Enter your email address" required>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-8 col-md-10 col-sm-3">
                                        <div class="form-group">
                                             <iframe style="height:800px; width: 100%;" src="foto_kk/<?php echo $p_fotokk ?>" alt="#" /></iframe>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-sm-8 offset-sm-2">
            ...
            <a style="background-color: grey; font-weight:bold; " href="a_pdk_view.php" type="button" class="btn btn-raised btn-primary btn-round waves-effect">KEMBALI</a>
