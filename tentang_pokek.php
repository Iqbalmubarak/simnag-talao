  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9">
        ...
        {
          ?>
                      <h3><li><?php echo $row['k_title']; ?></li></h3>
                      <img style="width: 800px;  height:300px;" class="margin_bottom_30_all" src="user/wisata/kegiatan_img/<?php echo $row['k_image']; ?>" alt="#">
                      <p><?php echo $row['k_message']; ?></p>
