      ...
      while ($row = $sqlqueryresult2 ->fetch_assoc())
      {
        ?>
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="user/wisata/berita_img/<?php echo $row['b_image']; ?>" alt="#"> </div>
            <div class="blog_feature_cantant">
              <p class="blog_head"><?php echo $row['b_title']; ?></p>
              <div class="post_info">
                <ul>
                  <li><i class="fa fa-user" aria-hidden="true"></i> <?php echo $row['b_author']; ?></li>
                  <li><i class="fa fa-circle" aria-hidden="true"></i> <?php echo $row['b_cat']; ?></li>
                  <li><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $row['b_date']; ?></li>
                </ul>
              </div>
              <p><?php echo substr($row['b_message'],0,400); ?>.... </p>
              <div class="bottom_info">
                <div class="pull-left"><a class="btn sqaure_bt" href="berita2.php?b_id=<?php echo $row['b_id']; ?>" >Read More<i class="fa fa-angle-right"></i></a></div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-left">
        <div class="side_bar">
          <div class="side_bar_blog">
            ...
            <div class="side_bar_blog">
              <h4>Mau Berkontribusi?</h4>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. sed do eiusmod tempor.</p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <a class="btn sqaure_bt" href="">Kirim Berita<i class="fa fa-angle-right"></i></a>
            </div>
